...
class MobitelRecommandationSList extends StatefulWidget {
  const MobitelRecommandationSList({Key? key}) : super(key: key);

  @override
  State<MobitelRecommandationSList> createState() =>
      _MobitelRecommandationSListState();
}

class _MobitelRecommandationSListState
    extends State<MobitelRecommandationSList> {
  @override
