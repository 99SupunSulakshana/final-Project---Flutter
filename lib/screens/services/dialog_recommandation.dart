...
class DialogRecommandationSList extends StatefulWidget {
  const DialogRecommandationSList({Key? key}) : super(key: key);

  @override
  State<DialogRecommandationSList> createState() =>
      _DialogRecommandationSListState();
}

class _DialogRecommandationSListState extends State<DialogRecommandationSList> {
  @override
