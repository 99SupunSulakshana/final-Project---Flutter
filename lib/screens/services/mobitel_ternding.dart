...
class MobitelTrendingListS extends StatefulWidget {
  const MobitelTrendingListS({Key? key}) : super(key: key);

  @override
  State<MobitelTrendingListS> createState() => _MobitelTrendingListSState();
}

class _MobitelTrendingListSState extends State<MobitelTrendingListS> {
  @override
