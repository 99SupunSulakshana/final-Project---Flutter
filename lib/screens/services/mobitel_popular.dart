...
class MobitelPoularList extends StatefulWidget {
  const MobitelPoularList({Key? key}) : super(key: key);

  @override
  State<MobitelPoularList> createState() => _MobitelPoularListState();
}

class _MobitelPoularListState extends State<MobitelPoularList> {
  @override
