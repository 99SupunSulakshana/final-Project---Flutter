...
class DialogTrendingListS extends StatefulWidget {
  const DialogTrendingListS({Key? key}) : super(key: key);

  @override
  State<DialogTrendingListS> createState() => _DialogTrendingListSState();
}

class _DialogTrendingListSState extends State<DialogTrendingListS> {
  @override
