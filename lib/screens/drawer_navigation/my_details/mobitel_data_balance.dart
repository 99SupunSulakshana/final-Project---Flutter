...
class MobitelData extends StatefulWidget {
  const MobitelData({Key? key}) : super(key: key);

  @override
  State<MobitelData> createState() => _MobitelDataState();
}

class _MobitelDataState extends State<MobitelData> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
            title: const Text("Mobitel Data Balance"),
            centerTitle: true,
            actions: []
        ),
        body: Center(
