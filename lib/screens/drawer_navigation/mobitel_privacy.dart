...
class MobitelPrivacy extends StatefulWidget {
  const MobitelPrivacy({
    Key? key,
  }) : super(key: key);
  //final News package;
  @override
  State<MobitelPrivacy> createState() => _MobitelPrivacyState();
}

class _MobitelPrivacyState extends State<MobitelPrivacy> {
  @override
