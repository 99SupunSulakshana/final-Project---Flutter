...
class _RegisterPageState extends State<RegisterPage> {
  final TextEditingController _email =
      TextEditingController(text: "supunsulak20@gmail.com");
  final TextEditingController _password =
      TextEditingController(text: "supun123");
  final TextEditingController _firstName = TextEditingController(text: "Supun");
  final TextEditingController _lastName =
      TextEditingController(text: "Sulakshana");
