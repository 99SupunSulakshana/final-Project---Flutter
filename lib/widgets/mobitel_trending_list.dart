...
import 'package:final_project/widgets/mobitel_trending_details.dart';
import 'package:flutter/material.dart';

class MobitelTrendingList extends StatefulWidget {
  const MobitelTrendingList({Key? key}) : super(key: key);

  @override
  State<MobitelTrendingList> createState() => _MobitelTrendingListState();
}

class _MobitelTrendingListState extends State<MobitelTrendingList> {
  @override
